...
- 003-expand-dataset: Added Python 3.13 + Faker (existing), Pydantic (existing), pytest (existing)

- 002-ollama-health-check: Added Python 3.11+ + FastAPI, Pydantic v2, httpx (already used), subprocess (stdlib), pytes
